...
@Component({
  selector: 'app-reiki-healing',
  templateUrl: './reiki-healing.component.html',
  styleUrls: ['./reiki-healing.component.css']
})
export class ReikiHealingComponent implements OnInit {
